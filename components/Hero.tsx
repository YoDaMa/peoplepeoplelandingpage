...
export default function Hero() {
  return (
    <section className="flex min-h-[calc(100vh-56px)] items-center px-6 pt-28 md:px-10 md:pt-20">
      <div className="mx-auto grid w-full max-w-[1200px] md:grid-cols-2 md:items-center md:gap-x-16">
        {/* Heading */}
        <motion.h1
          initial={{ opacity: 0, y: 30 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.8, ease: [0.25, 0.1, 0.25, 1] }}
          className="order-1 fluid-hero font-normal md:col-start-1"
        >
          hey there,
          <br />
        ...
        <motion.p
          ...
          className="order-2 fluid-body mt-6 max-w-xl text-muted md:col-start-1"
        >
        ...
        <motion.p
          ...
          className="order-3 fluid-body mt-4 max-w-xl font-normal md:col-start-1"
        >
          we&apos;re also a{" "}
        ...
        {/* Logo — after text on mobile, right column on desktop */}
        <motion.div
          ...
          className="order-4 mt-10 flex items-center justify-center md:order-none md:col-start-2 md:row-start-1 md:row-end-6 md:mt-0"
        >
          <Image
        ...
        <motion.div
          ...
          className="order-5 mt-10 flex flex-col gap-4 sm:flex-row md:col-start-1"
        >
          <StoreButton
        ...
        <motion.a
          ...
          className="order-6 link-underline mt-8 inline-block text-sm tracking-wide text-muted transition-colors hover:text-foreground md:col-start-1"
        >
